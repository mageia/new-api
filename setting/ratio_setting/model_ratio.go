...
var defaultModelPrice = map[string]float64{
	...
	"jimeng-video-seedance-2.0-fast-vip": 32.0 / common.QuotaPerUnit,
	"jimeng-video-seedance-2.0-mini":     0.4 / common.QuotaPerUnit,
	"jimeng-video-seedance-2.0-vip":      40.0 / common.QuotaPerUnit,
}
